...
// Code input component (like an OTP box)
...
function CreateOrgModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  if (done) {
    return (
      <Modal open={open} onClose={onClose} title="Organization Created!" size="md">
        <div className="text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-on-surface-variant/60 text-xs mt-2">Share this code with your team</p>
          </div>
          <Link href="/dashboard">
...
export default function LandingPage() {
  ...
  const handleJoin = async () => {
    ...
    if (code === 'ACME-XYZ') {
      ...
      setJoinError('Invalid invite code. Try ACME-XYZ for the demo.')
      setJoining(false)
    }
  }
          ...
          <div className="flex flex-col gap-8 items-center lg:items-start text-center lg:text-left animate-fade-in">
            ...
            <div className="relative w-full max-w-md aspect-video rounded-2xl overflow-hidden border border-white/8 glass-card group animate-float">
              <Image
                ...
                alt="Agile Toolkit 3D visualization"
                fill
            ...
            <div className="glass-card rounded-2xl p-8 relative overflow-hidden top-border-gradient">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  {joinError && (
                    <p className="text-center text-xs text-error mt-3">{joinError}</p>
                  )}
                </div>
